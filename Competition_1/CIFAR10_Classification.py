...
# ------------------ Parameter ------------------ #
train_batch_size = 100  # 50000 images, batch-size 500, iteration 100.
test_batch_size = 100
conv_1_layer = 32
conv_2_layer = 64
spatial_size = 5
...
def data_load():
    ...
    # randomly drop training sample
    # new_train_size = 40000
    # train_set, other_set = torch.utils.data.random_split(train_set, [new_train_size, len(train_set)-new_train_size])
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_times):
        ...
        print('Accuracy on 50000 train images: %.3f %%' % train_accuracy)
        print('Epoch %d - Training %.3f sec' % (epoch, time.time() - start_time))
        start_time = time.time()
        ...
        print('Accuracy on 10000 test images: %.3f %%' % test_accuracy)
        ...
        print('Epoch %d - Testing %.3f sec' % (epoch, time.time() - start_time))

    print("Training Finished")
    print('Total Time %.3f sec' % (time.time() - total_start_time))
